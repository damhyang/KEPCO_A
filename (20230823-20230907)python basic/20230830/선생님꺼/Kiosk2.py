...
k1 = MenuClass('원조김밥', Menu['김밥']['원조김밥'])            #category1, menu1
k2 = MenuClass('김치김밥', Menu['김밥']['김치김밥'])            #category1, menu2
k3 = MenuClass('참치김밥', Menu['김밥']['참치김밥'])            #category1, menu3

f1 = MenuClass('돈까스', Menu['돈까스']['돈까스'])              #category2, menu1
f2 = MenuClass('더블돈까스', Menu['돈까스']['더블돈까스'])      #category2, menu2
f3 = MenuClass('치킨까스', Menu['돈까스']['치킨까스'])          #category2, menu3
