...
# print(side1.getPrice())
# side2.setPrice(2000)
# print(side2.getPrice())
...
print(test[0].menu, test[1].ge)

class Kiosk():

    def __init__(self):     # admin, user, guest   사용자 / 필요요소를 담은 틀(O)
        self.name = ''
        self.price = 0
        self.total = 0
        self.money = 0
    ...
    def order(self, qty=0):                            #입력(X)
        while True:
            ...
            if (not menu) or menu == '0':                   # null 이나 '0'을 입력하면 주문종료
                menu = '0'
                break
